...
export class Ng2SliderComponent implements ISkinable{
    ...
    refreshInputBox(boundingRect, handle:RangeHandle) {
        ...
        switch (handle) {
            ...
            case RangeHandle.End:
                this.middleValue = value.toString();
                break;
            default:
                break;
        }
    ...
    refreshInputBoxByPercent(percent, handle:RangeHandle) {
        ...
        switch (handle) {
            case RangeHandle.Start:
                this.startValue = value.toString();
                this.midValue = (parseInt(this.middleValue) - value);
                this.endValue = 100 - (this.midValue + parseInt(value));
                break;
            case RangeHandle.End:
                this.middleValue = value.toString();
                this.midValue = (value - parseInt(this.startValue));
                this.endValue = 100 - (parseInt(this.startValue) + this.midValue);
                break;
            default:
                break;
        }
